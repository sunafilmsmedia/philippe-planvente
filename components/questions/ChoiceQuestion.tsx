        ...
        return (
          <motion.button
            ...
            className={`
              ...
              ${
                selected
                  ? "bg-[var(--color-brand-500)]/[0.08] border border-[var(--color-brand-500)]/70 shadow-[0_0_0_3px_rgba(178,58,43,0.12)]"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <span
                className={`
                  ...
                  ${
                    selected
                      ? "bg-[var(--color-brand-500)] border-[var(--color-brand-500)] shadow-[0_0_10px_rgba(178,58,43,0.45)]"
