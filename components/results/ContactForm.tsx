...
export default function ContactForm({ answers, verdict, onSubmitted }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // pour les verdicts trop faibles (preparation) est appliquée côté API.
  ...
  return (
    <motion.section
      ...
      className="
        ...
        shadow-[0_30px_80px_-30px_rgba(74,22,17,0.28)]
      "
    >
      ...
      <label className="flex items-start gap-3 cursor-pointer group select-none mt-5">
        ...
        <span className="text-xs sm:text-sm text-[var(--color-muted)] leading-relaxed">
          J&apos;accepte que {BROKER.name} m&apos;envoie mon plan de vente et puisse
          me contacter au sujet de mon projet.
        </span>
      </label>
